...
const refDir = process.env.INIT_CWD

// ANCHOR 1. Create symlink to .prettierrc
const prettierrcFilename = '.prettierrc'
const prettierrcPath = path.join(__dirname, prettierrcFilename)
...
const eslintConfigPath = path.join(__dirname, eslintConfigFilename)
